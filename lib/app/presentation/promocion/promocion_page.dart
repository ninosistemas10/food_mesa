            ...
            child: Column(
                ...
                children: [
                    Row(
                        ...
                        children: [
                            Text('Promociones', style: TextStyle(fontWeight: FontWeight.bold, color: AppColor.black, fontSize: 25)),
                            ButtonWidget(text: 'Agregar', fColor: AppColor.yellow, tColor: AppColor.black, onPress: () { }),
                        ],
                    ),
...
//                                                         Get.find<DataController>().postData(nameCategoria.text.trim(), descriCategoria.text.trim(), isActivo);
