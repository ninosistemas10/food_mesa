...
class TextCalorias extends StatefulWidget {
  final String label;
  ...
  @override
  State<TextCalorias> createState() => _TextCaloriasState();
}

class _TextCaloriasState extends State<TextCalorias> {
          ...
          Container(
            ...
            child: Align(
              ...
              child: TextField(
                ...
                inputFormatters: [
                  LengthLimitingTextInputFormatter(5), // Limita la longitud del texto a 5 caracteres
                  FilteringTextInputFormatter.allow(RegExp(r'^\d*\.?\d{0,1}$')), // Permite solo dígitos y un punto para números decimales
                ],
                ...
                decoration: InputDecoration(
                  ...
                  suffixText: 'cal    ', // Añade el texto 'cal' como sufijo
